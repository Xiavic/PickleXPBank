/*
*
* Source: https://github.com/LogBlock/LogBlock/blob/master/src/main/java/de/diddiz/util/MySQLConnectionPool.java
* @author Diddiz
*/
...
public class MySQLConnectionPool implements Closeable
{
	...
	public MySQLConnectionPool(String url, String user, String password) throws ClassNotFoundException {
		...
		new Thread(reaper, "MySQL Connection Reaper Thread - PickleXpBank").start();
	}
